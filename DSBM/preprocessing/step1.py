...
if __name__ == '__main__':
    ...
    # patients.sort()
    #case_pixels, m1, m2, spacing = step1_python('/share5/gaor2/data/MCL/Large_MCL_set2/29550499216/29550499216')
    case_pixels, m1, m2, spacing, bwcp, bw = step1_python('/home/local/VANDERBILT/lil18/Desktop/test5/12143271663time20151105')
    print ('hello world')
    plt.imshow(bwcp[100])
    plt.show()
    plt.imshow(bw[100])
